...
export const BOT_PERSONAS: readonly BotPersona[] = [
  ...
  },
  {
    ...
    shortBackstory: 'An archivist of Siwalai endgames, known for turning small technical details into positions with no practical escape.',
    personalityHook: 'Patient, exact, and difficult to unbalance once the position becomes concrete.',
    personalityTraits: ['patient', 'technical', 'severe'],
    toneOfVoice: 'Quiet, deliberate, and analytical.',
    playstyleTags: ['technical', 'defensive', 'forcing'],
    difficultyLevel: 'master',
    openingPreference: 'Builds a resilient shape first, then searches for forcing moves only after every loose square has been counted.',
    strategicTendencies: ['Prioritizes king safety and conversion', 'Rejects speculative attacks unless calculation supports them'],
    chatStyle: 'Sparse comments with a technical edge.',
    tacticalBias: 'Forcing defenses, clean conversions, and late tactical turns.',
    strategicWeakness: 'May spend a tempo preserving control before choosing a direct finish.',
    signatureStyle: 'A compact structure that becomes a precise endgame bind.',
    flavorIntroLine: 'Let us make every tempo account for itself.',
    winLine: 'The record was clear before the final move.',
    lossLine: 'You found the line I could not close.',
    thinkingLine: 'There is a forcing detail here.',
    reactionLines: [
      'That move deserves calculation.',
      'You have made the position less simple.',
    ],
    engine: {
      level: 11,
      aggression: 0.9,
    ...
    dialogue: {
      intro: ['Let us make every tempo account for itself.', 'Accuracy will be enough.'],
      neutral: ['A useful square is rarely wasted.', 'The position asks for discipline.'],
      tactical: ['The forcing line is now available.', 'This move removes the practical defense.'],
      praise: ['That move deserves calculation.', 'You have made the position less simple.'],
      pressure: ['Your margin is becoming narrow.', 'The defense now has fewer useful choices.'],
      endgame: ['The count matters now.', 'Technique should finish what calculation began.'],
      victory: ['The record was clear before the final move.', 'There was no need to hurry.'],
      defeat: ['You found the line I could not close.', 'The archive will remember that resource.'],
      thinking: ['There is a forcing detail here.', 'I need the move that leaves no repair.'],
      reaction: ['That move deserves calculation.', 'You have made the position less simple.'],
    },
  },
  {
    id: 'ajarn-krailert',
    ...
    shortBackstory: 'The Royal Hall teacher reserved for players who have already beaten every other Siwalai master.',
    personalityHook: 'Direct, exacting, and uninterested in beautiful mistakes.',
    personalityTraits: ['austere', 'calculating', 'commanding'],
    toneOfVoice: 'Plain, clipped, and authoritative.',
    playstyleTags: ['elite', 'precise', 'punishing'],
    difficultyLevel: 'master',
    openingPreference: 'Chooses principled development, then calculates forcing transitions as soon as the position permits.',
    strategicTendencies: ['Finds defensive resources quickly', 'Converts advantages without offering counterplay'],
    chatStyle: 'Very short comments with little ornament.',
    tacticalBias: 'Deep forcing moves, mate defense, and exact recaptures.',
    strategicWeakness: 'Almost none by design; only tight resource limits hold the strength practical.',
    signatureStyle: 'Immediate practical pressure backed by hard calculation.',
    flavorIntroLine: 'Begin.',
    winLine: 'That was the position speaking.',
    lossLine: 'You earned that result.',
    thinkingLine: 'Calculate, then move.',
    reactionLines: [
      'Correct.',
      'That answer changes the evaluation.',
    ],
    engine: {
      level: 12,
      aggression: 1.05,
    ...
    dialogue: {
      intro: ['Begin.', 'No ceremony is needed.'],
      neutral: ['Improve the worst piece.', 'The position is still balanced.'],
      tactical: ['This is forced.', 'The reply is not enough.'],
      praise: ['Correct.', 'That answer changes the evaluation.'],
      pressure: ['Now defend accurately.', 'The position is asking too much of you.'],
      endgame: ['Technique decides this.', 'Every count must be exact.'],
      victory: ['That was the position speaking.', 'The conversion was direct.'],
      defeat: ['You earned that result.', 'That was sufficient calculation.'],
      thinking: ['Calculate, then move.', 'The first candidate is not always the move.'],
      reaction: ['Correct.', 'That answer changes the evaluation.'],
    },
  },
] as const;
