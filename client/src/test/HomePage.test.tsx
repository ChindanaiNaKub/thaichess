...
describe('HomePage', () => {
  ...
  it('renders the learn section and footer guide links in Thai', async () => {
    ...
    expect(screen.getByText('เรียนรู้หมากรุกไทย')).toBeInTheDocument();
    expect(screen.getByText('สามหน้าสั้น ๆ จากรู้จักเกม ไปจนถึงเริ่มเล่นได้จริง')).toBeInTheDocument();
