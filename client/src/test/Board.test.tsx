  ...
  return {
    ...
    useBoardAppearance: () => ({
      boardTheme: {
        baseColor: '#d0b285',
        gridColor: '#8c6b42',
        surfaceBackground: 'linear-gradient(180deg, rgba(255,255,255,0.12), transparent 16%, transparent 82%, rgba(77,52,24,0.08)), #d0b285',
        frameBackground: 'linear-gradient(180deg, rgba(120,85,45,0.4), rgba(48,33,21,0.56))',
        coordinateColor: '#775a38',
        hoverBackground: 'linear-gradient(180deg, rgba(255,255,255,0.1), transparent 45%), #dbc096',
        selectedBackground: 'linear-gradient(180deg, rgba(255,255,255,0.12), transparent 45%), #c5a36f',
        selectedRing: '#f1e1b8',
        lastMoveBackground: 'linear-gradient(180deg, rgba(255,255,255,0.08), transparent 42%), #cfb47c',
        premoveBackground: 'linear-gradient(180deg, rgba(255,255,255,0.08), transparent 42%), #b8c19b',
        premoveRing: '#dce3ba',
        legalDot: 'rgba(36, 30, 24, 0.28)',
        legalCapture: 'rgba(36, 30, 24, 0.28)',
        checkOverlay: 'radial-gradient(ellipse at center, rgba(177, 51, 39, 0.74) 0%, rgba(114, 26, 21, 0.34) 56%, transparent 82%)',
        legacyPreviewLight: '#ead3b0',
        legacyPreviewDark: '#b48758',
        material: 'wood',
        validation: {
          gridContrast: 1.5,
          weakestPieceContrast: 2.5,
        },
      },
    }),
  };
