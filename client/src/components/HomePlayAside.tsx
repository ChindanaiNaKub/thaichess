...
export function HomePlayAside(props: HomePlayAsideProps) {
  ...
  const {
    ...
    isCreating, createError, privatePanel, privateExpanded, joinId, setJoinId, timePresets,
  ...
  return (
    <aside className="grid content-start gap-3">
      {privateExpanded ? (
        <div className="ui-card p-4 sm:p-5">
          <div className="mb-3 flex items-center gap-2.5">
            ...
            <h2 className="text-base font-semibold text-text-bright">{t('home.play_friend')}</h2>
          </div>
        ...
        >
          <div className="flex items-center gap-2.5">
            <FriendSVG size={22} className="text-text-bright flex-shrink-0" />
            <div>
              <div className="text-sm font-semibold text-text-bright">{t('home.play_friend')}</div>
              <div className="text-xs text-text-dim">{t('home.play_friend_desc')}</div>
            </div>
          </div>
        </button>
      )}
      ...
      <div className="ui-card p-4">
        <div className="mb-3 text-xs font-semibold uppercase tracking-[0.16em] text-text-dim">{t('home.more_ways')}</div>
