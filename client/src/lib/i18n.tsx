...
const EN: Record<string, string> = {
  ...
  'home.lessons_desc': 'Guided tactics by track',
  ...
  'bot.setup_desc': 'Choose a bot persona, review its style and rating, pick your side, then begin. Random side is decided only when the game begins.',
  ...
  'puzzle.lessons_desc': 'Use the existing puzzle catalog as structured study tracks. Filter by difficulty, repeat tactical themes, and work through the queue at your own pace.',
...
const TH: Record<string, string> = {
  ...
  'home.lessons_desc': 'ฝึกเป็นเส้นทางตามระดับ',
  ...
  'bot.setup_desc': 'เลือกบุคลิกบอท ดูสไตล์และเรตติ้ง เลือกฝั่ง แล้วเริ่มเกมซ้อมได้เลย หากเลือกสุ่ม ระบบจะตัดสินฝั่งให้ตอนเริ่มเกมเท่านั้น',
  ...
  'puzzle.lessons_desc': 'ใช้ชุดปริศนาเดิมเป็นเส้นทางเรียนแบบมีโครงสร้าง เลือกระดับ ฝึกธีมซ้ำ และค่อย ๆ ไล่ตามคิวได้ตามจังหวะของคุณ',
