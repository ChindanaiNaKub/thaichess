...
export const EN_TRANSLATIONS: Record<string, string> = {
  ...
  'auth.hero_desc': 'Use Google or Facebook for the fastest sign-in. You can still play casually without an account, and email remains available as a fallback during migration.',
  ...
  'auth.benefit_fast': 'Google and Facebook work in one tap, with email kept only as fallback.',
  'auth.social_title': 'Choose a sign-in method',
  'auth.social_desc': 'Google and Facebook are the main login methods now. Email is still available if you need recovery or a fallback.',
  ...
  'auth.email_fallback_desc': 'Use a one-time code only if you cannot use Google or Facebook yet.',
...
const TH: Record<string, string> = {
  ...
  'auth.hero_desc': 'ใช้ Google หรือ Facebook เพื่อเข้าสู่ระบบให้เร็วที่สุด คุณยังเล่นแบบสบาย ๆ โดยไม่ต้องมีบัญชีได้ และยังมีอีเมลเป็นทางเลือกสำรองระหว่างการย้ายระบบ',
  ...
  'auth.benefit_fast': 'Google และ Facebook ใช้แตะครั้งเดียว ส่วนอีเมลเก็บไว้เป็นทางเลือกสำรอง',
  'auth.social_title': 'เลือกวิธีเข้าสู่ระบบ',
  'auth.social_desc': 'Google และ Facebook คือวิธีหลักสำหรับการเข้าสู่ระบบตอนนี้ ส่วนอีเมลยังมีไว้เป็นทางเลือกสำรองหรือกู้คืนบัญชี',
  'auth.continue_with_google': 'ใช้ Google ต่อ',
  'auth.continue_with_facebook': 'ใช้ Facebook ต่อ',
  'auth.or_email_fallback': 'ใช้อีเมลแทน',
  'auth.email_fallback_title': 'สำรองด้วยอีเมล',
  'auth.email_fallback_desc': 'ใช้รหัสแบบครั้งเดียวเมื่อคุณยังใช้ Google หรือ Facebook ไม่ได้',
