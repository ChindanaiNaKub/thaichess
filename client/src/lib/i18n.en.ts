export const EN_TRANSLATIONS: Record<string, string> = {
  ...
  'privacy.cookies.text': 'We use essential cookies and localStorage for service operation: User authentication (sessions), Language and theme settings, Puzzle and lesson progress (for guests). If you opt in, we may also load privacy-friendly analytics (Plausible) that does not use advertising cookies or sell personal data. | เราใช้คุกกี้ที่จำเป็นสำหรับการทำงาน: การยืนยันตัวตน การตั้งค่าภาษาและธีม ความคืบหน้าปริศนา หากคุณยินยอม เราอาจโหลดการวิเคราะห์ที่เน้นความเป็นส่วนตัว (Plausible) โดยไม่ใช้คุกกี้โฆษณา',
