export const EN_TRANSLATIONS: Record<string, string> = {
  ...
  'bot.featured_opponent': 'Your opponent',
  'bot.recommended': 'Recommended',
  'bot.show_all_bots': 'Show all bots',
  'bot.show_featured': 'Show featured only',
  'bot.change_opponent': 'Change opponent',
  'bot.hide_roster': 'Done choosing',
  'bot.strength_bands': 'Strength bands',
  'bot.band_learning': 'Learning',
  'bot.band_club': 'Club',
  'bot.band_strong': 'Strong',
  'bot.band_elite': 'Elite',
  'bot.carousel_go_to': 'Go to {name}',
  'bot.search_bots': 'Search bots',
  'bot.search_bots_placeholder': 'Search by name or title',
  'bot.search_empty': 'No bots match that search.',
  ...
  'game.waiting_desc': 'Share this link with a friend. The game starts when they join.',
  'game.waiting_help': 'Keep this tab open while you wait. If you need a game now, leave this room and play a bot instead.',
  'game.waiting_play_bot': 'Play vs Bot instead',
  'game.copy': 'Copy',
  'game.copied': 'Copied!',
  ...
  'game.error': 'Error',
  'game.error_rate_limited': 'Too many requests — wait a moment and try again.',
  'game.error_leave_current': 'Leave your current game or queue before starting another.',
  'game.error_invalid_game': 'That game link is invalid.',
  'game.error_leave_before_join': 'Leave your current game before joining another one.',
  'game.error_game_full': 'This game is full. You can watch as a spectator.',
  'game.error_not_found': 'Game not found.',
  'game.error_spectate_unavailable': 'Unable to spectate this game. It may no longer exist.',
  'game.error_leave_before_spectate': 'Leave your current game before spectating another one.',
  'game.error_not_in_game': 'You are not in a game.',
  'game.error_invalid_move': 'That move is not legal.',
  'game.error_opponent_left': 'Your opponent already left the finished game.',
  'game.error_leave_before_queue': 'Leave your current game before entering matchmaking.',
  'game.error_already_queued': 'You are already searching for a game.',
  'game.error_join_failed': 'Could not join this game. Try again.',
  'game.error_invalid_request': 'Something was wrong with that request. Try again.',
  ...
  'game.offer_draw_confirm': 'Offer a draw to your opponent?',
  'game.offer_draw_confirm_action': 'Offer draw',
  'game.resign': '⚐ Resign',
  'game.resign_confirm': 'Resign this game? You will lose.',
  'game.resign_confirm_action': 'Resign',
  'game.share': 'Share',
  'game.open_spectator': 'Watch as spectator',
  'game.piece_guide': 'Piece Guide',
  'game.opponent_dc': 'Opponent disconnected. Waiting for reconnection...',
  'game.game_label': 'Game:',
  'game.tools': 'Share & watch',
  ...
  'game.counting_learn_more': 'Read the full rule',
  'game.premove_set': 'Pre-move set',
  'game.check_status': 'Check on board',
  'announce.move': '{piece} {from} to {to}',
  'announce.capture': 'captures {piece}',
  'announce.promotion': 'promotes to {piece}',
  'announce.check': 'Check!',
  'announce.game_over_winner': 'Game over. {color} wins {reason}.',
  'announce.game_over_draw': 'Game over. Draw {reason}.',
  ...
  'game.show_share': 'Share result',
  'game.hide_share': 'Hide share',
  'game.show_review': 'Review moves',
  'game.hide_review': 'Hide review',
  'game.endgame_more_tools': 'More on this game',
  'game.endgame_hide_tools': 'Hide more',
  'game.endgame_study': 'Study this game',
  'game.endgame_hide_study': 'Hide study',
  ...
  'local.play_online': 'Leave for online play',
  ...
  'games.load_failed': 'Could not load your games. Try again.',
  'games.empty': 'No games yet',
  'games.empty_desc': 'Be the first to play!',
  'games.empty_bot': 'No bot games yet',
  'games.empty_bot_desc': 'Challenge a computer opponent — results will show up here.',
  'games.empty_rated': 'No rated games yet',
  'games.empty_rated_desc': 'Find a rated opponent to start building this history.',
  'games.empty_casual': 'No casual games yet',
  'games.empty_casual_desc': 'Play a casual quick game — finishes land here.',
  'games.empty_play_bot': 'Play vs Bot',
  'games.empty_find': 'Find opponent',
  ...
  'games.more_tools': 'More tools',
  'games.hide_tools': 'Hide tools',
  ...
  'live.empty_desc': 'Public quick-play games appear here when they start. Or start one yourself.',
  'live.empty_find': 'Find opponent',
  'live.empty_bot': 'Play vs Bot',
  'live.card_live': 'Live',
  ...
  'live.mode_private': 'Private',
  'live.mode_private_rated': 'Rated Private',
  ...
  'sharecard.more_styles': 'More card styles',
  'sharecard.hide_styles': 'Hide card styles',
  ...
  'account.show_history': 'Show puzzle history',
  'account.hide_history': 'Hide puzzle history',
  'account.show_security': 'Manage sessions & security',
  'account.hide_security': 'Hide security',
  'account.show_details': 'Show account details',
  'account.hide_details': 'Hide account details',
  'account.show_admin_security': 'Admin MFA setup',
  'account.hide_admin_security': 'Hide admin MFA',
  'account.sessions_title': 'Active sessions',
  'account.sessions_desc': 'Review devices and sign out ones you no longer trust.',
  'account.sessions_show': 'Show active sessions',
  'account.sessions_refresh': 'Refresh sessions',
  'account.sessions_loading': 'Loading...',
  'account.session_current': 'Current device',
  'account.session_other': 'Other device',
  'account.session_unknown_device': 'Unknown device',
  'account.session_expires': 'Valid until {date}',
  'account.session_sign_out_device': 'Sign out device',
  'account.session_sign_out_others': 'Sign out other devices',
  'account.sessions_load_failed': 'Could not load active sessions. Try again.',
  'account.session_revoke_failed': 'Could not sign out that device. Try again.',
  'account.sessions_revoke_others_failed': 'Could not sign out other devices. Try again.',
  ...
  'account.delete_desc': 'Deleting your account will permanently remove all your data. This action cannot be undone.',
  'account.delete_show': 'Delete account…',
  'account.delete_hide': 'Hide',
  'account.delete_action': 'Delete my account',
  'account.delete_confirm': 'Yes, delete account',
  'account.delete_warning': 'Are you sure? Your account, ratings, and all game history will be permanently deleted.',
  'account.delete_success': 'Your account has been deleted.',
  'account.delete_redirecting': 'Your account has been deleted. Redirecting to home...',
  'account.delete_deleting': 'Deleting...',
  'account.delete_error': 'Could not delete account. Please try again.',
  'account.admin_security_title': 'Two-factor authentication',
  'account.admin_security_desc': 'Two-factor authentication is required before admin tools can be used.',
  'account.admin_security_status': 'Status: {status}',
  'account.admin_security_enabled': 'Enabled',
  'account.admin_security_disabled': 'Not enabled',
  'account.admin_security_setup': 'Set up admin MFA',
  'account.admin_security_preparing': 'Preparing...',
  'account.admin_security_uri_help': 'Add this account to your authenticator app, then enter the first code below.',
  'account.admin_security_code': 'Authenticator code',
  'account.admin_security_verify': 'Verify admin MFA',
  'account.admin_security_verifying': 'Verifying...',
  'account.admin_security_backup': 'Backup codes',
  'account.admin_security_setup_started': 'Authenticator setup started. Scan the URI, then verify one code to finish enabling admin MFA.',
  'account.admin_security_setup_failed': 'Could not start admin MFA setup. Try again.',
  'account.admin_security_enabled_msg': 'Admin MFA is enabled. Save your backup codes before leaving this page.',
  'account.admin_security_verify_failed': 'Could not verify that code. Check the authenticator and try again.',
